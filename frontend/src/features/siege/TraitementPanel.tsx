  ...
  const executer = async () => {
    try {
      if (action === 'accepter') {
        ...
        toast.notifier('Demande acceptée : le distributeur est notifié.', 'success');
  ...
  return (
    <Card titre="🏢 Instruction par le siège" variante="plain">
      ...
      >
        {action === 'accepter' && (
          <p>
            La demande passera au statut <strong>Traitée – Acceptée</strong>. Le distributeur sera notifié.
          </p>
        )}
        {action === 'refuser' && (
          <>
